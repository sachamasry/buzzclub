defmodule BuzzClubNative do
  ...
  import BuzzClubWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {BuzzClubWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([BuzzClubWeb, CoreComponents, plugin.module_suffix])
