defmodule BuzzClubWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `BuzzClubWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BuzzClubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BuzzClubWeb.Gettext, "errors", msg, opts)
    end
  end
